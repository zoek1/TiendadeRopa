...
private  JLabel label;
 ...
 private JFrame Contenedor;
  ...
  public CambiarContraseniaGui(String NameArchivo){
    ...
    this.NameArchivo = NameArchivo;
      ...
      tmp = JOptionPane.showInputDialog(null,"Ingresa Contraseña a eliminar");

      
      ImageIcon icono = new ImageIcon("Emblemas/Seguridad-48.png");

      JLabel  IconoSeguridad=new JLabel(new ImageIcon("Emblemas/Cambiar-48.png"));
  ...
  public void actionPerformed(ActionEvent e){
	...
	JOptionPane.showMessageDialog(null,"Constraseña ya existe");
      ...
      }else{JOptionPane.showMessageDialog(null,"Contraseña inexistente");}   } else{ //The user has asked for help.
